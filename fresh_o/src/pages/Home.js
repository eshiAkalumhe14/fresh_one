        ...
        <div className="pick-of-the-month-section">
          ...
          <div className="section-content">
            ...
            <div className="section-recipe">
              ...
              <ul>
                <li>
                  Fresh Catfish<strong> (2kg)</strong>{' '}
                </li>
                <li>
                  Pepper Soup Spice<strong> (2 tbsp) </strong>
                </li>
                <li>
                  Scotch Bonnet peppers <strong>(2)</strong>{' '}
                </li>
              ...
              <ol>
                <li>
                  Place cleaned catfish in a pot with sliced onions, pepper, and seasoning cubes.
                </li>
      ...
      <div className="section3">
        ...
        <div>
          <p className="section3-description">
            At Fresh One Frozen Foods, we go beyond selling frozen meats — we deliver a trusted
            experience, built around Nigerian taste, convenience, and quality. Here’s what makes us
            truly different:
          </p>
        </div>
        ...
        <div className="section3-container">
          ...
          <div className="section3-content">
            <div className="section3-card">
              ...
              <p>
                From Point-and-Kill catfish to shawa and smoked turkey, we bring Nigerian flavours
                straight to your freezer. Frozen at peak freshness to lock in taste and nutrients —
                enjoy that true homely taste every time.
              </p>
            </div>
            ...
            <div className="section3-card">
              ...
              <p>
                We deliver across Nigeria — fast and fresh. Choose Same-Day delivery in select
                cities or reliable Next-Day shipping nationwide. No more market runs; just doorstep
                convenience.
              </p>
            </div>
            ...
            <div className="section3-card">
              ...
              <p>
                All products are professionally cleaned, cut, and sealed — ready for your pot. Save
                time and skip the stress. Just thaw, season, and cook your favorite stew, soup, or
                suya.
              </p>
            </div>
            ...
            <div className="section3-card">
              ...
              <p>
                We serve Nigerian families, students, caterers, and food vendors with pride. Our
                platform is made by Nigerians, for Nigerians — focused on quality, culture, and
                trust.
              </p>
            </div>
            ...
            <div className="section3-card">
              ...
              <p>
                Get transparent pricing and combo packs that save you more. From small orders to
                party-sized bulk deliveries — we’ve got your table covered.
              </p>
            </div>
          </div>
        </div>
